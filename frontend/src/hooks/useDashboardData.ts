...
export function useDashboardData(activeView: ActiveView) {
  ...
  return {
    ...
    deleteHotConfigPatchGenerator: inventory.deleteHotConfigPatchGenerator,
    ...
    renderSourceConfigPatch: inventory.renderSourceConfigPatch,
    renderHotConfigPatchGenerator: inventory.renderHotConfigPatchGenerator,
    ...
    hotConfigPatchGenerators: inventory.hotConfigPatchGenerators,
    ...
    upsertHotConfigPatchGenerator: inventory.upsertHotConfigPatchGenerator,
