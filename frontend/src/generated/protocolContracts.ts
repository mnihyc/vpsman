...
export const JOB_COMMAND_SAFETY_BY_OPERATION_TYPE = {
  ...
  "network_apply": "write",
  "network_ospf_cost_update": "write",
  "network_rollback": "write",
  "network_status": "read",
...
export const PRIVILEGE_OPERATION_GOLDEN_VECTORS = [
  ...
  { command_type: "hot_config", input_json: "{\"type\":\"hot_config\",\"apply_mode\":\"full_override\",\"toml\":\"version = 1\\n\",\"preserve_redacted\":false,\"base_config_sha256_hex\":\"5555555555555555555555555555555555555555555555555555555555555555\"}", canonical_json: "{\"type\":\"hot_config\",\"apply_mode\":\"full_override\",\"toml\":\"version = 1\\n\",\"preserve_redacted\":false,\"base_config_sha256_hex\":\"5555555555555555555555555555555555555555555555555555555555555555\"}" },
  { command_type: "data_source_config_patch", input_json: "{\"type\":\"data_source_config_patch\",\"apply_mode\":\"incremental_patch\",\"toml\":\"[data_sources]\\n\"}", canonical_json: "{\"type\":\"data_source_config_patch\",\"apply_mode\":\"incremental_patch\",\"toml\":\"[data_sources]\\n\"}" },
  ...
  { command_type: "network_apply", input_json: "{\"type\":\"network_apply\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"left\",\"config_backend\":\"ifupdown\",\"config_sha256_hex\":\"cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc\",\"ifupdown_sha256_hex\":\"dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd\",\"bird2_sha256_hex\":\"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee\"}", canonical_json: "{\"type\":\"network_apply\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"left\",\"config_backend\":\"ifupdown\",\"config_sha256_hex\":\"cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc\",\"ifupdown_sha256_hex\":\"dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd\",\"bird2_sha256_hex\":\"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee\"}" },
  { command_type: "network_ospf_cost_update", input_json: "{\"type\":\"network_ospf_cost_update\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"left\",\"current_ospf_cost\":120,\"recommended_ospf_cost\":80,\"bird2_sha256_hex\":\"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee\"}", canonical_json: "{\"type\":\"network_ospf_cost_update\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"left\",\"current_ospf_cost\":120,\"recommended_ospf_cost\":80,\"bird2_sha256_hex\":\"eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee\"}" },
  { command_type: "network_rollback", input_json: "{\"type\":\"network_rollback\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"right\"}", canonical_json: "{\"type\":\"network_rollback\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"right\"}" },
  { command_type: "network_status", input_json: "{\"type\":\"network_status\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"left\"}", canonical_json: "{\"type\":\"network_status\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"left\"}" },
  { command_type: "network_interfaces", input_json: "{\"type\":\"network_interfaces\"}", canonical_json: "{\"type\":\"network_interfaces\"}" },
  { command_type: "network_probe", input_json: "{\"type\":\"network_probe\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"left\",\"count\":3,\"interval_ms\":500}", canonical_json: "{\"type\":\"network_probe\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"side\":\"left\",\"count\":3,\"interval_ms\":500}" },
  { command_type: "network_speed_test", input_json: "{\"type\":\"network_speed_test\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"server_side\":\"left\",\"duration_secs\":3,\"max_bytes\":16777216,\"rate_limit_kbps\":100000,\"port\":5201,\"connect_timeout_ms\":5000}", canonical_json: "{\"type\":\"network_speed_test\",\"plan\":{\"name\":\"left-a-right-b\",\"interface_name\":\"tunab\",\"kind\":\"gre\",\"left_client_id\":\"left-a\",\"right_client_id\":\"right-b\",\"left_underlay\":\"198.51.100.10\",\"right_underlay\":\"203.0.113.20\",\"left_tunnel_address\":\"10.255.0.0\",\"right_tunnel_address\":\"10.255.0.1\",\"tunnel_prefix_len\":31,\"ipv4_tunnel\":{\"left\":\"10.255.0.0\",\"right\":\"10.255.0.1\",\"prefix_len\":31},\"latency_primary_family\":\"ipv4\",\"bandwidth\":\"100m\",\"recommended_ospf_cost\":20,\"ifupdown_file\":\"/etc/network/interfaces.d/vpsman-tunnels\",\"bird2_file\":\"/etc/bird/vpsman-ospf.conf\",\"ifupdown_snippet\":\"# vpsman tunnel left-a-right-b: generated plan only\\nauto tunab\\niface tunab inet static\\n    address 10.255.0.0\\n    netmask 255.255.255.254\\n    pointopoint 10.255.0.1\\n    pre-up ip tunnel add $IFACE mode gre remote 203.0.113.20 local 198.51.100.10 ttl 255\\n    up ip link set $IFACE up\\n    post-down ip tunnel del $IFACE || true\",\"bird2_interface_snippet\":\"# vpsman GRE tunnel left-a-right-b: left-a -> right-b\\ninterface \\\"tunab\\\" {\\n  type ptp;\\n  cost 20;\\n};\",\"touched_files\":[\"/etc/network/interfaces.d/vpsman-tunnels\",\"/etc/bird/vpsman-ospf.conf\"],\"validation_steps\":[\"review generated snippets before apply\",\"run ifreload --syntax-check for ifupdown2-managed snippets where available\",\"run bird -p before Bird2 reload where available\",\"verify tunnel latency and packet loss before accepting OSPF cost\"],\"rollback_notes\":[\"remove only the vpsman-managed interface block from /etc/network/interfaces.d/vpsman-tunnels\",\"remove only the matching vpsman-managed Bird2 interface block\",\"reload networking and Bird2 after validation succeeds\"],\"conflicts\":[],\"mutates_host\":false},\"server_side\":\"left\",\"duration_secs\":3,\"max_bytes\":16777216,\"rate_limit_kbps\":100000,\"port\":5201,\"connect_timeout_ms\":5000}" },
