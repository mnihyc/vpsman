...
- Shared custom preset: one operator-managed preset assigned to pools, tags, or
  explicit clients.
...
Use the Pools panel for the same workflow when operating visually.
...
Then assign it to a tag or pool:
