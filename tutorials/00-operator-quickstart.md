...
Use pools for provider/resource ownership and tags for operating intent.
Always resolve targets before bulk work:
...
Assign shared presets to tags or pools, and reserve VPS-local presets for
machine-specific custom commands.
