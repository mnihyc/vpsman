...
- relevant logs with credentials, private keys, tokens, hostnames, and operator
  data removed; and
...
operator privilege material, internal tokens, or live access tokens.
...
between the public console, internal API, and gateway-control interfaces.
