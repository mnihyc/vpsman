...
Environment:
  ...
  VPSMAN_CLIENT_ID          Opaque unique agent id; generated by default
...
generate_client_id() {
  if command -v uuidgen >/dev/null 2>&1; then
    ...
    die "missing required tool for client id generation: uuidgen or openssl"
  fi
}
...
prompt_value VPSMAN_CLIENT_ID "Opaque agent client id" "$(generate_client_id)"
