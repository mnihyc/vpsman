...
commands=(
  ...
  source-templates source-template-create source-template-clone source-template-diff source-template-test source-template-update source-status source-template-assignments source-config-patch source-config-patch-apply source-template-assign
  ...
  file-pull file-push file-transfer-upload file-transfer-download file-transfers file-transfer-handoff file-transfer-sources file-transfer-source-upload file-transfer-source-download user-sessions hot-config config-patch agent-update agent-update-check agent-update-activate agent-update-rollback agent-update-release-record agent-update-release-latest agent-update-releases
  ...
  bulk-resolve tunnel-plans tunnel-allocate tunnel-plan tunnel-plan-export tunnel-promote-external-observe tunnel-promote-custom-adapter tunnel-apply tunnel-ospf-cost-update tunnel-rollback
...
workflow_for_command() {
  ...
  case "$command" in
    ...
    user-sessions|process-list|process-start|process-stop|process-restart|process-status|process-logs|process-supervisor-inventory)
      ...
      ;;
    hot-config|config-patch|agent-update|agent-update-check|agent-update-activate|agent-update-rollback|agent-update-release-record|agent-update-release-latest|agent-update-releases)
    ...
    backups|backup-artifacts|backup-policies|backup-policy-upsert|backup-policy-prune|restore-plans|migration-links|backup-request|backup-run|backup-artifact-record|backup-artifact-upload|backup-artifact-upload-chunked|backup-artifact-handoff|restore-plan|migration-link|migration-run|restore-run|restore-rollback)
      ...
      ;;
    network-observations|network-trends|network-ospf-recommendations|network-ospf-update-plans|topology-graph|tunnel-plans|tunnel-allocate|tunnel-plan|tunnel-plan-export|tunnel-promote-external-observe|tunnel-promote-custom-adapter|tunnel-apply|tunnel-ospf-cost-update|tunnel-rollback|tunnel-status|tunnel-probe|tunnel-speed-test)
