...
commands=(
  ...
  jobs job-cancel schedules schedule-create schedule-update schedule-enable schedule-disable schedule-defer schedule-apply-now schedule-delete job-create job-shell
  ...
  file-pull file-push file-transfer-upload file-transfer-download file-transfers file-transfer-handoff file-transfer-sources file-transfer-source-upload file-transfer-source-download user-sessions hot-config agent-update agent-update-check agent-update-activate agent-update-rollback agent-update-signature agent-update-release-publish agent-update-artifact-upload agent-update-release-latest agent-update-releases agent-update-rollouts agent-update-rollout-policies agent-update-rollout-policy-create agent-update-rollout-activate agent-update-rollout-rollback agent-update-rollout-control
  ...
  tunnel-status tunnel-probe tunnel-speed-test noise-keygen signing-keygen vty
)

root_help="$("$bin" --help)"
for expected in "operators" "operator-create" "operator-sessions" "operator-session-revoke" "totp-setup" "totp-confirm" "totp-disable" "client-key-revocations" "client-key-revoke" "key-lifecycle-report" "fleet-alerts" "fleet-alert-export" "fleet-alert-states" "fleet-alert-state-update" "fleet-alert-policies" "fleet-alert-policy-upsert" "fleet-alert-notification-channels" "fleet-alert-notification-channel-upsert" "fleet-alert-notifications" "fleet-alert-notification-dispatch" "fleet-alert-notification-process" "gateway-sessions" "telemetry-rollups" "telemetry-network-rates" "telemetry-tunnels" "data-source-presets" "data-source-preset-create" "data-source-preset-clone" "data-source-preset-diff" "data-source-preset-test" "data-source-preset-update" "data-source-status" "data-source-assignments" "data-source-hot-config" "data-source-hot-config-apply" "data-source-preset-assign" "job-cancel" "job-shell" "job-follow" "job-output-artifact" "history-retention" "history-retention-upsert" "history-retention-prune" "history-export" "terminal-sessions" "terminal-replay" "terminal-follow" "file-transfers" "file-transfer-handoff" "file-transfer-sources" "file-transfer-source-upload" "file-transfer-source-download" "backup-policies" "backup-policy-upsert" "backup-policy-prune" "backup-artifact-upload-chunked" "backup-artifact-handoff" "tunnel-speed-test" "tunnel-promote-telemetry" "tunnel-promote-adapter" "tunnel-ospf-cost-update" "restore-run" "restore-rollback" "migration-links" "migration-link" "migration-run" "network-observations" "network-trends" "network-ospf-recommendations" "network-ospf-update-plans" "topology-graph" "agent-update" "agent-update-check" "agent-update-activate" "agent-update-rollback" "agent-update-signature" "agent-update-release-publish" "agent-update-artifact-upload" "agent-update-release-latest" "agent-update-releases" "agent-update-rollouts" "agent-update-rollout-policies" "agent-update-rollout-policy-create" "agent-update-rollout-activate" "agent-update-rollout-rollback" "agent-update-rollout-control" "process-supervisor-inventory"; do
