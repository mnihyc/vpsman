...
commands=(
  ...
  file-pull file-push file-transfer-upload file-transfer-download file-transfers file-transfer-handoff file-transfer-sources file-transfer-source-upload file-transfer-source-download user-sessions hot-config config-patch agent-update agent-update-check agent-update-activate agent-update-rollback agent-update-release-publish agent-update-release-latest agent-update-releases
...
workflow_for_command() {
  ...
  case "$command" in
    ...
    user-sessions|process-list|process-start|process-stop|process-restart|process-status|process-logs|process-supervisor-inventory)
      ...
      ;;
    hot-config|config-patch|agent-update|agent-update-check|agent-update-activate|agent-update-rollback|agent-update-release-publish|agent-update-release-latest|agent-update-releases)
