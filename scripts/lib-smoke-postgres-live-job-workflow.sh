...
wait_agent_connected "$client_id"
wait_agent_connected "$peer_client_id"
...
assert_user_sessions_no_proof_rejection
...
jq -n \
  ...
  '{
    ...
    checks: ["auth_session", "enrollment", "agent_noise_connect", "gateway_session_lifecycle", "proof_gated_shell_job", "proof_gated_shell_pty_job", "proof_gated_shell_script_job", "job_output_follow_cli", "job_output_follow_vty", "live_shell_output_streaming", "large_job_output_artifact_retention", "active_in_flight_job_cancel", "timed_out_shell_job", "proof_gated_file_pull", "terminal_session_lifecycle", "terminal_session_poll_output", "terminal_session_inventory", "resumable_file_transfer_upload", "resumable_file_transfer_download", "file_transfer_session_inventory", "no_proof_user_sessions_rejected", "proof_gated_user_sessions", "proof_gated_process_start", "proof_gated_process_status", "proof_gated_process_logs", "proof_gated_process_restart", "proof_gated_process_stop", "process_supervisor_inventory", "proof_gated_file_push", "job_target_output_audit", "network_status_observation", "network_probe_observation", "network_speed_observations", "network_observation_trends", "network_ospf_recommendations", "network_ospf_update_plans", "api_restart"]
  }'
