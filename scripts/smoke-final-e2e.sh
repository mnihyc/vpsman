...
require_log_marker smoke-postgres-persistence.log '"postgres_direct_identity_key_rotation"'
...
require_log_marker smoke-direct-identity-gateway-failover.log '"direct_identity_gateway_failover_smoke"'
