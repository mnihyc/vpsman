...
require_log_marker smoke-vpsctl-live-api.log '"pool_tag_bulk"'
require_log_marker smoke-vpsctl-live-api.log '"backup_request_restore_plan"'
require_log_marker smoke-vpsctl-live-api.log '"data_source_workflow_readiness"'
require_log_marker smoke-vpsctl-live-api.log '"data_source_process_limit_readiness"'
require_log_marker smoke-vpsctl-live-api.log '"no_plaintext_password_in_cli_outputs"'
require_log_marker smoke-postgres-persistence.log '"postgres_reenrollment_key_rotation"'
...
require_log_marker smoke-live-agent-update.log '"delegated_failure_rollback": "dispatched_and_rolled_back"'
require_log_marker smoke-live-network-apply.log '"adapter_rollback_job_id"'
require_log_marker smoke-live-data-source-config-patch.log '"no_proof_rejected": true'
require_log_marker smoke-live-data-source-config-patch.log '"command_execution_policy_fields": "verified"'
require_log_marker smoke-live-hot-config.log '"api_restart": "verified"'
require_log_marker smoke-signed-discovery-failover.log '"dead_tcp_failover"'
...
printf '  "log_dir": "%s",\n' "$log_dir"
printf '  "checks": ["auth_and_no_plaintext_cli", "reenrollment_persistence", "client_key_revocation", "terminal_sessions", "terminal_retention_flow_window", "resumable_transfers", "backup_restore_rollback", "backup_policy_retention_prune", "backup_chunked_upload", "migration_run_restore", "agent_update_delegated_rollback", "runtime_network_adapter", "data_source_workflow_readiness", "data_source_process_limit_readiness", "data_source_hot_config", "command_execution_policy_fields", "signed_discovery_failover", "low_resource_reconnect", "low_resource_post_telemetry_budget", "ui_cli_vty_parity", "structured_cli_output"]\n'
printf '}\n'
