...
printf '  "log_dir": "%s",\n' "$log_dir"
printf '  "checks": ["auth_and_no_plaintext_cli", "reenrollment_persistence", "client_key_revocation", "terminal_sessions", "terminal_retention_flow_window", "resumable_transfers", "backup_restore_rollback", "backup_policy_retention_prune", "backup_chunked_upload", "migration_run_restore", "agent_update_direct_jobs", "runtime_network_adapter", "data_source_workflow_readiness", "data_source_process_limit_readiness", "data_source_hot_config", "command_execution_policy_fields", "signed_discovery_failover", "low_resource_reconnect", "low_resource_post_telemetry_budget", "ui_cli_vty_parity", "structured_cli_output"]\n'
printf '}\n'
