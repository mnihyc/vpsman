...
VALUES (
  ...
  '{"schema":"vpsman.fleet_alert.notification.v1","alert":{"id":"agent_status:agent:pg-worker"}}'::jsonb,
  NULL,
  0,
  0,
  NULL,
...
VALUES (
  ...
  '{"schema":"vpsman.fleet_alert.notification.v1","alert":{"id":"agent_status:agent:old"}}'::jsonb,
  NULL,
  0,
  1,
