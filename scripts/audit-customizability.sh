...
classified_pattern='#!|preset|config|argv|source|adapter|definition|default|fixture|test|smoke|placeholder|managed|vpsman-tunnels|vpsman-ospf|docs/|README.md|DESIGN.md|customizability|render_data_source_hot_config'
