...
workflows=(
  ...
  'terminal authorized input control|terminal-input|terminal-input|terminalSocket.queueInput|frontend/src/panels/jobs/TerminalSessionsPanel.tsx'
  ...
  'terminal authorized resize control|terminal-resize|terminal-resize|terminalSocket.queueResize|frontend/src/panels/jobs/TerminalSessionsPanel.tsx'
  ...
  'configuration override set|config-source-set|config-source-set|Save selection|frontend/src/panels/ConfigurationSourcesPanel.tsx'
  ...
  'effective configuration render|config-render|config-render|Inspect current effective config|frontend/src/panels/ConfigurationSourcesPanel.tsx'
  ...
  'port forward enable|port-forward-enable|port-forward-enable|label: "Enable"|frontend/src/panels/topology/PortForwardingPanel.tsx'
  'port forward disable|port-forward-disable|port-forward-disable|label: "Disable"|frontend/src/panels/topology/PortForwardingPanel.tsx'
  'port forward delete|port-forward-delete|port-forward-delete|label: "Delete"|frontend/src/panels/topology/PortForwardingPanel.tsx'
  ...
  'port forward reapply|port-forward-reapply|port-forward-reapply|Reapply replaces this VPS|frontend/src/panels/topology/PortForwardingPanel.tsx'
  ...
  'port forward bulk mutation|port-forward-bulk|port-forward-bulk|reviewMutation("enable", rows)|frontend/src/panels/topology/PortForwardingPanel.tsx'
  'tunnel plan|tunnel-plan|tunnel-plan|Create tunnel plan|frontend/src/panels/TopologyPanel.tsx'
  'tunnel plan export|tunnel-plan-export|tunnel-plan-export|label: "Export"|frontend/src/panels/TopologyPanel.tsx frontend/src/hooks/useTopologyData.ts'
  ...
  'tunnel plan credential rotation|tunnel-plan-rotate-credentials|tunnel-plan-rotate-credentials|label: "Rotate credentials"|frontend/src/panels/TopologyPanel.tsx frontend/src/hooks/useTopologyData.ts'
  ...
  'OSPF updater status refresh|tunnel-ospf-status-refresh|tunnel-ospf-status-refresh|label: "Check updater"|frontend/src/panels/topology/TopologyOspfUpdateControls.tsx frontend/src/hooks/useTopologyData.ts'
  'external observed tunnel|tunnel-plan|tunnel-plan|External observed|frontend/src/panels/TopologyPanel.tsx'
  'custom tunnel adapter binding|tunnel-plan|tunnel-plan|Custom adapter|frontend/src/panels/TopologyPanel.tsx'
