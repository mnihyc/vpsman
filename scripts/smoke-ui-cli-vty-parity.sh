...
workflows=(
  ...
  'agent update release publish|agent-update-release-publish|agent-update-release-record|External release metadata|frontend/src/panels/jobs/AgentUpdateReleasesPanel.tsx'
  ...
  'data source config patch render|data-source-hot-config|data-source-hot-config|Render selected config|frontend/src/panels/DataSourcePresetPanel.tsx'
  'data source config patch apply|data-source-hot-config-apply|data-source-hot-config-apply|Review apply|frontend/src/panels/DataSourcePresetPanel.tsx'
