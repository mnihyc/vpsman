...
workflows=(
  ...
  'routing adapter status refresh|tunnel-ospf-status-refresh|tunnel-ospf-status-refresh|Check routing adapter status|frontend/src/panels/topology/TopologyOspfUpdateControls.tsx frontend/src/hooks/useTopologyData.ts'
  'external observed tunnel|tunnel-plan|tunnel-plan|External observed|frontend/src/panels/TopologyPanel.tsx'
  'external managed tunnel adapter|tunnel-plan|tunnel-plan|External adapter|frontend/src/panels/TopologyPanel.tsx frontend/src/panels/SourceTemplatesPanel.tsx'
  'routing cost adapter binding|tunnel-plan|tunnel-plan|Left routing adapter|frontend/src/panels/TopologyPanel.tsx frontend/src/panels/SourceTemplatesPanel.tsx'
