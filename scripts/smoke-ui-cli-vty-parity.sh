...
workflows=(
  ...
  'full config override dispatch|hot-config|hot-config|mode: "hot_config"|frontend/src/panels/jobs/JobOperationControls.tsx'
  ...
  'source template list|source-templates|source-templates|Source templates|frontend/src/panels/SourceTemplatePanel.tsx'
  'source template create|source-template-create|source-template-create|Source template definition|frontend/src/panels/SourceTemplatePanel.tsx'
  'source template assignments|source-template-assignments|source-template-assignments|source template assignment records|frontend/src/panels/SourceTemplatePanel.tsx'
  'source status|source-status|source-status|Active source status|frontend/src/panels/SourceTemplatePanel.tsx'
  'source config patch render|source-config-patch|source-config-patch|Render template patch|frontend/src/panels/SourceTemplatePanel.tsx'
  'source config patch apply|source-config-patch-apply|source-config-patch-apply|Review apply|frontend/src/panels/SourceTemplatePanel.tsx'
  'source template assign|source-template-assign|source-template-assign|Assign source template|frontend/src/panels/SourceTemplatePanel.tsx'
