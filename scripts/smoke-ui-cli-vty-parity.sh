...
workflows=(
  ...
  'operator totp confirm|totp-confirm|totp-confirm|Confirm TOTP|frontend/src/panels/AccessPanel.tsx frontend/src/hooks/useAccessData.ts'
  'operator totp disable|totp-disable|totp-disable|Disable TOTP|frontend/src/panels/AccessPanel.tsx frontend/src/hooks/useAccessData.ts'
  'enrollment token list|enrollment-tokens|enrollment-tokens|Enrollment tokens|frontend/src/panels/AccessPanel.tsx frontend/src/hooks/useAccessData.ts'
  'enrollment token create|enrollment-token-create|enrollment-token-create|Create token|frontend/src/panels/AccessPanel.tsx frontend/src/hooks/useAccessData.ts'
  'reenrollment token create|reenrollment-token-create|reenrollment-token-create|Rebuild token|frontend/src/panels/AccessPanel.tsx frontend/src/hooks/useAccessData.ts'
  'client key revocations|client-key-revocations|client-key-revocations|Key lifecycle|frontend/src/panels/AccessPanel.tsx frontend/src/hooks/useAccessData.ts'
  ...
  'super-password rotation|super-password-rotate|super-password-rotate|mode: "auth_rotate"|frontend/src/panels/jobs/JobOperationControls.tsx frontend/src/panels/jobDispatchModel.ts'
  'super-password rotation history|super-password-rotations|super-password-rotations|Proof rotation history|frontend/src/panels/AccessPanel.tsx frontend/src/hooks/useAccessData.ts'
  ...
  'agent update rollout records|agent-update-rollouts|agent-update-rollouts|Agent update rollouts|frontend/src/panels/jobs/AgentUpdateRolloutsPanel.tsx'
  'agent update rollout policies|agent-update-rollout-policies|agent-update-rollout-policies|Rollout policy presets|frontend/src/panels/jobs/AgentUpdateRolloutsPanel.tsx frontend/src/hooks/useJobsData.ts'
  'agent update rollout policy create|agent-update-rollout-policy-create|agent-update-rollout-policy-create|onCreatePolicy|frontend/src/panels/jobs/AgentUpdateRolloutsPanel.tsx frontend/src/hooks/useJobsData.ts'
  'agent update rollout activate|agent-update-rollout-activate|agent-update-rollout-activate|activateRolloutBatch|frontend/src/panels/JobHistoryPanel.tsx'
  'agent update rollout rollback|agent-update-rollout-rollback|agent-update-rollout-rollback|rollbackRolloutTargets|frontend/src/panels/JobHistoryPanel.tsx'
  'agent update rollout delegate rollback|agent-update-rollout-delegate-rollback|agent-update-rollout-delegate-rollback|delegateRolloutRollback|frontend/src/panels/JobHistoryPanel.tsx frontend/src/panels/jobs/AgentUpdateRolloutsPanel.tsx frontend/src/hooks/useJobsData.ts'
  'agent update rollout delegate activation|agent-update-rollout-delegate-activation|agent-update-rollout-delegate-activation|delegateRolloutActivation|frontend/src/panels/JobHistoryPanel.tsx frontend/src/panels/jobs/AgentUpdateRolloutsPanel.tsx frontend/src/hooks/useJobsData.ts'
  'agent update rollout control|agent-update-rollout-control|agent-update-rollout-control|automation_health_gate|frontend/src/panels/jobs/AgentUpdateRolloutsPanel.tsx frontend/src/hooks/useJobsData.ts'
  ...
  'job cancel pending|job-cancel|job-cancel|onCancelJob|frontend/src/panels/JobHistoryPanel.tsx frontend/src/hooks/useJobsData.ts'
  'schedule create|schedule-create|schedule-create|Create schedule|frontend/src/panels/SchedulesPanel.tsx'
  'schedule dispatch|schedule-dispatch|schedule-dispatch|onDispatchScheduledJob|frontend/src/panels/JobHistoryPanel.tsx'
  'pool create|pool-create|pool-create|Resource pool|frontend/src/panels/PoolsTagsPanel.tsx'
  'agent pool assign|agent-pool|agent-pool|onAssignPool|frontend/src/panels/PoolsTagsPanel.tsx'
  'tag create|tag-create|tag-create|Custom tag|frontend/src/panels/PoolsTagsPanel.tsx'
  'agent tag assign|agent-tag|agent-tag|onAssignTag|frontend/src/panels/PoolsTagsPanel.tsx'
  'bulk resolve|bulk-resolve|bulk-resolve|onResolveBulk|frontend/src/panels/PoolsTagsPanel.tsx'
  ...
  'data source hot config apply|data-source-hot-config-apply|data-source-hot-config-apply|Apply selected patch|frontend/src/panels/DataSourcePresetPanel.tsx'
  ...
  'backup request|backup-request|backup-request|Request backup|frontend/src/panels/backups/BackupRequestForm.tsx'
  ...
  'restore run|restore-run|restore-run|Run restore|frontend/src/panels/backups/RestoreRunForm.tsx'
  'restore rollback|restore-rollback|restore-rollback|Rollback restore|frontend/src/panels/backups/RestoreRollbackForm.tsx'
  'migration link|migration-link|migration-link|Link migration|frontend/src/panels/backups/MigrationLinkForm.tsx'
  'migration run|migration-run|migration-run|Run migration restore|frontend/src/panels/backups/MigrationLinkForm.tsx frontend/src/panels/BackupsPanel.tsx'
