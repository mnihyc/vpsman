...
pub(crate) fn dispatch(ctx: &CommandContext, command: Command) -> Result<Option<Command>> {
    ...
    match command {
            ...
            commands_schedules::schedule_create(
                ...
                commands_schedules::ScheduleCreateOptions {
                    definition: commands_schedules::ScheduleDefinitionOptions {
                        ...
                        argv: command.argv,
                        pty: command.pty,
                        event_expression: command.event_expression,
                        event_argv_template: command.event_argv_template,
        ...
        Command::ScheduleRefreshTargets(command) => {
            commands_schedules::schedule_refresh_targets(
                api_url,
                token,
                command.schedule_id,
                command.confirmed,
