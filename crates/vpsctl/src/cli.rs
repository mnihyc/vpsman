...
use crate::cli_access::{
    ...
    EnrollConfigCommand, EnrollmentSettingsUpdateCommand, EnrollmentTokenCreateCommand,
    ...
    ReenrollmentTokenCreateCommand, RefreshCommand, ScheduleCreateCommand, ScheduleDeferCommand,
...
pub(crate) enum Command {
    ...
    EnrollmentTokens,
    EnrollmentSettings,
    EnrollmentSettingsUpdate(EnrollmentSettingsUpdateCommand),
    EnrollmentTokenCreate(EnrollmentTokenCreateCommand),
    ReenrollmentTokenCreate(ReenrollmentTokenCreateCommand),
