...
pub enum MessageKind {
    ...
    AgentSessionDisconnect,
    AgentUpdateVerificationRequest,
    AgentUpdateVerificationResult,
    TerminalControl,
    TerminalControlAck,
    FileChunk,
    ConfigUpdate,
...
impl MessageKind {
    pub fn from_u16(value: u16) -> Self {
        match value {
            ...
            38 => Self::CommandResume,
            36 => Self::TerminalStreamOutput,
            39 => Self::AgentSessionDisconnect,
            40 => Self::AgentUpdateVerificationRequest,
            41 => Self::AgentUpdateVerificationResult,
            42 => Self::TerminalControl,
            43 => Self::TerminalControlAck,
            48 => Self::FileChunk,
    ...
    pub fn as_u16(self) -> u16 {
        match self {
            ...
            Self::CommandResume => 38,
            Self::TerminalStreamOutput => 36,
            Self::AgentSessionDisconnect => 39,
            Self::AgentUpdateVerificationRequest => 40,
            Self::AgentUpdateVerificationResult => 41,
            Self::TerminalControl => 42,
            Self::TerminalControlAck => 43,
            Self::FileChunk => 48,
