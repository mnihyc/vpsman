...
pub(crate) struct MemoryState {
    ...
    pub(crate) scheduled_jobs: Arc<RwLock<HashMap<Uuid, ScheduledJobDispatchRecord>>>,
    ...
    pub(crate) agent_update_rollback_delegations:
        Arc<RwLock<Vec<AgentUpdateRollbackDelegatedProofRecord>>>,
