...
pub(crate) const SCOPE_INTEGRATIONS_WRITE: &str = "integrations:write";
pub(crate) const SCOPE_TEMPLATES_READ: &str = "templates:read";
pub(crate) const SCOPE_TEMPLATES_WRITE: &str = "templates:write";
...
pub(crate) const SCOPE_HISTORY_WRITE: &str = "history:write";
pub(crate) const SCOPE_SHARING_READ: &str = "sharing:read";
pub(crate) const SCOPE_SHARING_WRITE: &str = "sharing:write";
