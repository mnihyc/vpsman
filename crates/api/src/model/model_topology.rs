...
pub(crate) struct TopologyGraphEdgeView {
    ...
    pub(crate) left_reachability_source: Option<String>,
    pub(crate) right_reachability_source: Option<String>,
    pub(crate) left_reachability_observed_at: Option<String>,
    pub(crate) right_reachability_observed_at: Option<String>,
    ...
    pub(crate) reachability_state: String,
